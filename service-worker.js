...
const CACHE_VERSION = "resultados-pwa-v134-matriz-estudiantes";
...
self.addEventListener("fetch", (event) => {
  ...
  // v134: Supabase y cualquier API externa de datos vivos nunca se guardan ni se leen de CacheStorage.
